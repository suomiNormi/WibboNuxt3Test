<template>
  <div class="absolute top-2 left-1">
    <div class="px-2 py-1 bg-gray-800 border rounded-md cursor-pointer hover:bg-gray-700 border-gray-950" @click="hasHistory() ? navigateTo(lastRouteName) : navigateTo('/home')">
