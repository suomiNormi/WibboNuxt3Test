<template>
  <div class="grid grid-cols-1 gap-4">
    ...
    <Transition name="page" :mode="'out-in'" :duraction="250">
          ...
          <BaseCard class="mb-2">
            ...
            <template #body>
              <div class="relative w-auto h-48 overflow-hidden bg-gray-800 rounded case">
                <img :src="$nuxt.$config.public.cdnUrl + '/furni/' + rare.catalog_name + '.png'" class="absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" draggable="false">
